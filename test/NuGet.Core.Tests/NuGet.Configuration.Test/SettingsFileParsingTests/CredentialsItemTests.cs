...
<configuration>
    <packageSourceCredentials>
        ...
        public void Update_WhenItemIsADifferentCredentialsItem_ReturnsFalse()
        {
            ...
            // Act
            credentials.Update(new CredentialsItem("notName", "user", "notpass", isPasswordClearText: true)).Should().BeFalse();
        ...
        public void Update_WhenOriginIsMachineWide_ReturnsFalse()
        {
            ...
            // Act
            credentials.Update(new CredentialsItem("name", "user", "notpass", isPasswordClearText: true)).Should().BeFalse();
        ...
        public void Update_ChangeUsername_UpdatesObjectAndXNode()
        {
            ...
            // Act
            credentials.Update(new CredentialsItem("name", "newuser", "pass", isPasswordClearText: false)).Should().BeTrue();
        ...
        public void Update_ChangePassword_UpdatesObjectAndXNode()
        {
            ...
            // Act
            credentials.Update(new CredentialsItem("name", "user", "newpass", isPasswordClearText: false)).Should().BeTrue();
        ...
        public void Update_ChangeClearTextPassword_UpdatesObjectAndXNode()
        {
            ...
            // Act
            credentials.Update(new CredentialsItem("name", "user", "newpass", isPasswordClearText: true)).Should().BeTrue();
